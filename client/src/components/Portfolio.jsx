  ...
  constructor(props) {
    ...
    this.state = {
      ...
      projects: [
        ...
        {index: 3, title: 'title4', description: 'AbleBoxPro handles cloud storage and editing with Zoho and SQL. Files are stored both through a centralized server (AWS S3) as well as on a decentralized network with blockchain encryption (IPFS).', image: './tnablebox.png', link: 'https://glacial-island-66806.herokuapp.com/home'},
