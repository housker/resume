/* Text animation adapted from
https://codepen.io/mimikos/pen/QMjjzy
a Pen by DIACO : twitter.com/Diaco_ml || codepen.io/MAW
powered by GSAP : https://www.greensock.com/
A Pen created at CodePen.io. You can find this one at https://codepen.io/mimikos/pen/QMjjzy.
...
window.executeHome = function() {
  ...
  tl.to(line,tl.duration()/2,{opacity:R(0.1,1),x:R(-window.innerWidth/2,window.innerWidth/2),ease:RoughEase.ease.config({strength:0.5,points:10,randomize:true,taper: "none"}),repeat:1},0);
    ...
    for (var i=0; i < 10; i++){
      ...
      dot.className = 'dot';
      document.getElementById('first').prepend(dot);
     setDotPosition(dot);
